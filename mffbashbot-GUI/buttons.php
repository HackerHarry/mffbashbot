...
print "if (document.getElementById('weathermitigation') !== null)\n";
...
print "if (document.getElementById('summercut') !== null)\n";
...
print "if (document.getElementById('wintercut') !== null)\n";
...
print "if (document.getElementById('vinedefoliation') !== null)\n";
...
print "if (document.getElementById('vinefertiliser') !== null)\n";
