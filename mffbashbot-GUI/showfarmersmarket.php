<?php
// Show farmers market file for Harry's My Free Farm Bash Bot (front end)
...
for ($pc = 0; $pc <= 2; $pc++) {
 ...
 print "</tr><tr>";
 print "<td align=\"center\" colspan=\"" . $iNumQueues . "\"><form action=\"makeW3Chappy\" name=\"selpos" . $position[$pc] . "\" style=\"margin-bottom:0\">";
