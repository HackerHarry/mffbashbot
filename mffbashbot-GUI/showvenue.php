...
switch ($farm) {
 case "city2":
  $position = [0 => ["windmill", $strings['mill'], "windmill"], 1 => ["trans25", $strings['trans25'], "trans25"], 2 => ["trans26", $strings['trans26'], "trans26"], 3 => ["powerups", $strings['powerups'], "powerups"], 4 => ["tools", $strings['tools'], "tools"], 5 => ["cowracepvp", $strings['cowracepvp'], "cowracepvp"]];
  break;
 case "foodworld":
