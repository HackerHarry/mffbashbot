...
$megafieldvehicleslist = [1 => "Жътварка", 2 => "Количка за реколта", 3 => "Механичен комбайн", 4 => "Парен комбайн", 5 => "Крилатна машина за прибиране на реколтата", 6 => "Трактор", 7 => "Автоматичен комбайн", 8 => "Прецизен комбайн", 9 => "Компютърно управлявана комбайна", 10 => "Комбайн-O-Трон 2000"];
...
$strings['cowracepvp'] = 'Кравешко състезание PvP';
