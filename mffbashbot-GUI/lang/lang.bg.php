...
"tinkergame9" => "Червена парти шапка",
"tinkergame3" => "Остра шапка",
"tinkergame10" => "Зелена парти шапка",
"tinkergame4" => "Голяма остра шапка",
"tinkergame11" => "Розово тромпетче",
"tinkergame5" => "Тромпетен храст",
"tinkergame12" => "Зелена лилия тромпетче",
"tinkergame6" => "Голяма тромпетен растение",
"invasion1" => "Маршмелоу хибискус",
"invasion4" => "Шоколадов козунак",
"invasion2" => "Слънчогледова дъвка",
"invasion5" => "Шоколоадова гъба",
...
"giftdeliveryevent4" => "n/a",
"giftdeliveryevent5" => "n/a",
