...
"tinkergame7" => "Балон Сукулент",
"tinkergame1" => "Балонни билки",
"tinkergame8" => "Балон Маргаритка",
"tinkergame2" => "Диви балонни билки",
"tinkergame9" => "Красива червена шапка",
"tinkergame3" => "Остра шапка",
"tinkergame10" => "Красива зелена шапка",
"tinkergame4" => "Голяма остра шапка",
"tinkergame11" => "Тромпетен розов храст",
"tinkergame5" => "Тромпетен храст",
"tinkergame12" => "Зелена тромпетна лилия",
...
$strings['oxcart'] = 'Каруца';
$strings['lighttruck'] = 'Бус платформа';
$strings['suv'] = 'СЮВ';
...
$strings['dogreenhouse'] = 'Събери бонус точки от оранжерията';
$strings['dogreenhouse-tt'] = 'Този бонус може да бъде събран на всеки 23 часа.';
// $strings[''] = '';
?>
